...
if [ -f "$MYSQL_CREDENTIALS_FILE" ]; then
    ...
    echo ""
    echo "💡 Use './scripts/configure-cloudbeaver-connections.sh' for detailed setup help"
    echo ""
fi
...
echo "🔧 Run './scripts/configure-cloudbeaver-connections.sh' for connection setup help"
